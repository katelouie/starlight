"""
HTML Reference Sheet Generator (starlight.visualization.reference_sheet)
...
def generate_html_reference(
    filename: str = "starlight_color_reference.html",
    ...
    """
    Generate a comprehensive HTML reference sheet for all Starlight colors and palettes.
    ...
    Example:
        >>> from starlight.visualization import generate_html_reference
...
<head>
    ...
    <title>Starlight Color & Theme Reference</title>
    <style>
        body {
...
<body>
    <h1>🌟 Starlight Color & Theme Reference</h1>
    <p>
        This reference sheet shows all available color palettes and themes in the Starlight visualization system.
...
"""
    ...
    <p style="text-align: center; color: #888; font-size: 0.9em;">
        Generated by <strong>Starlight</strong> - Computational Astrology Library<br>
        For more information, visit the <a href="https://github.com/katelouie/starlight">GitHub repository</a>
    </p>
</body>
</html>
"""
